...
public class Monster : LivingEntity
{
    ...
    void Awake()
    {
        ...
        SetStatus(30, 10, 8.5f);//ÀÏ´Ü ÀÏ¹İ¸÷±âÁØ
    ...
    {
        isDead = false;
        SetStatus(30, 5, 8.5f);//ÀÏ´Ü ÀÏ¹İ¸÷±âÁØ
        Health = MaxHealth;//Ã¼·ÂÀ» ÃÖ´ëÃ¼·ÂÀ¸·Î ¼³Á¤ 
    }
    ...
    {
        RaycastHit2D GateHit= Physics2D.Raycast(RayPos, dirVec, 1.75f, LayerMask.GetMask("Gate"));//Ray¸¦ ¹ß»çÇÏ¿© ÇÃ·¹ÀÌ¾î°¡ ¹üÀ§³»¿¡ ÀÖ´ÂÁö È®ÀÎ
    ...
    private void DoAttack()
    {
        ...
        Invoke("Attack", 0.4f);//¾Ö´Ï¸ŞÀÌ¼Ç¿¡¼­ ÈÖµÎ¸£´Â ¸ğ¼Ç¿¡ ¸Â°Ô °ø°İ
        ...
        private void Attack()
    {
        ...
        foreach (Collider2D collider in collider2Ds)
        {
            ...
            {
                Gate.damaged(damage);//°ÔÀÌÆ®¿¡ ÇÇÇØ¸¦ ÁÜ
            }
        }
    }//¹üÀ§³» °ø°İ
