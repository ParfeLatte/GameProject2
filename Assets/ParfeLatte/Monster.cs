...
public class Monster : LivingEntity
{
    ...
    void Awake()
    {
        ...
        SleepState = 0;
        SetStatus(31, 10, 4.5f);//ÀÏ´Ü ÀÏ¹İ¸÷±âÁØ
        Health = MaxHealth;
    }
    ...
    private void OnWake()
    {
        if (SleepState == 3)
        {
            Debug.DrawRay(MR.position, dirVec * 1.2f, new Color(0, 1, 0));//·¹ÀÌÄ³½ºÆ® Ç¥½Ã(°Å¸® È®ÀÎ¿ë)
